    ...
    return (
        <div style={{ height: '100%' }}>
            ...
            <Flex gap='xs' justify={'center'}>
                <Button compact fullWidth variant='outline' leftIcon={<IconPlus size={18} />}>NewFile</Button>
                <Button compact fullWidth variant='outline' leftIcon={<IconUpload size={18} />}>Upload</Button>
            </Flex>
        </div >
    )
}
